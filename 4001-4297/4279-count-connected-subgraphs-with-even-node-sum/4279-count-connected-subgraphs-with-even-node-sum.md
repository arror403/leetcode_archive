<h1>4279 - Count Connected Subgraphs with Even Node Sum</h1><h2>Difficulty: Hard - <a href="https://leetcode.com/problems/count-connected-subgraphs-with-even-node-sum/">count-connected-subgraphs-with-even-node-sum</a></h2><p>You are given an undirected graph with <code>n</code> nodes labeled from 0 to <code>n - 1</code>. Node <code>i</code> has a <strong>value</strong> of <code>nums[i]</code>, which is either 0 or 1. The edges of the graph are given by a 2D array <code>edges</code> where <code>edges[i] = [u<sub>i</sub>, v<sub>i</sub>]</code> represents an edge between node <code>u<sub>i</sub></code> and node <code>v<sub>i</sub></code>.</p>
