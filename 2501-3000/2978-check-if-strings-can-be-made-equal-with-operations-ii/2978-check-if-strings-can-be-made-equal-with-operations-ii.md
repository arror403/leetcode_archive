<h1>2978 - Check if Strings Can be Made Equal With Operations II</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/check-if-strings-can-be-made-equal-with-operations-ii/">check-if-strings-can-be-made-equal-with-operations-ii</a></h2><p>You are given two strings <code>s1</code> and <code>s2</code>, both of length <code>n</code>, consisting of <strong>lowercase</strong> English letters.</p>
