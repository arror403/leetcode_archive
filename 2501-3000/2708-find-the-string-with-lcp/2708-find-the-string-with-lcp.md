<h1>2708 - Find the String with LCP</h1><h2>Difficulty: Hard - <a href="https://leetcode.com/problems/find-the-string-with-lcp/">find-the-string-with-lcp</a></h2><p>We define the <code>lcp</code> matrix of any <strong>0-indexed</strong> string <code>word</code> of <code>n</code> lowercase English letters as an <code>n x n</code> grid such that:</p>
